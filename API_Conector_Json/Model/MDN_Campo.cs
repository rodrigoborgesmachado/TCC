...
using static TCC.Util.Enumerator;
    ...
    public class MDN_Campo
    {
        ...
        public string InsertFieldDataBase()
        {
            ...
            switch (this.type)
            {
                ...
                case DataType.DATE:
                    command_sql += " INTEGER ";
                    command_sql += (notnull ? " DEFAULT " + Util.DataBase.Date_to_Int(DateTime.Parse((this.ValueDefault == null ? 0.ToString() : this.ValueDefault.ToString()))) + " NOT NULL " : (unique ? "UNIQUE" : ""));
                    break;
                ...
                case DataType.INT:
                    command_sql += " INTEGER ";
                    command_sql += (notnull ? " DEFAULT " + int.Parse((this.ValueDefault == null ? 0.ToString() : this.ValueDefault.ToString())) + " NOT NULL " : (unique ? " UNIQUE " : ""));
                    break;
